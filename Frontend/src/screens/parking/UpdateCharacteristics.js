...
const UpdateCharacteristics = ({ parkingId }) => {
  ...
  const features = [
    ...
    { label: '¿Ofrece estacionamiento para discapacitados?', state: hasDisabledParking, setState: setHasDisabledParking },
    { label: '¿Cuenta con cargadores para vehículos eléctricos?', state: hasEVChargers, setState: setHasEVChargers },
